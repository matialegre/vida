...
**Modelo (v3, definido por Matías 2026-08-31 con el lead de Venado Tuerto):** el hardware **NO se vende** — va en **comodato con depósito de garantía reintegrable** (base $150.000 · batería+cargador $80.000 · módulo 4G $100.000) + **instalación remota $50.000/cámara** (kit preconfigurado + electricista local + videollamada; Matías no viaja) + **desarrollo a medida $300.000-$500.000** cuando el caso lo pide + **abono mensual (v4, ÷3 el 31-ago)**: $25.000 primera cámara + $15.000 cada adicional + $4.000 por boca de sensado + $3.000 por sensor de puerta + $15.000/mes por base Premium (batería + 4G, única línea que no se dividió por 3: la SIM con SMS y llamadas cuesta $10-15k/mes) + $3.000/mes por sirena + $8.000/mes WhatsApp opcional. Todos los precios planos, sin escalas. Cobro por **transferencia mensual**, ajuste trimestral por IPC, baja con 30 días, todo en un **contrato de servicio + comodato**. **Dos niveles de producto:** Estándar (WiFi del sitio, Telegram + push) y **Premium** (batería + 4G, único que avisa el corte de luz por internet/SMS/llamada). Módulo opcional aparte, a medida: transferencia automática a grupo electrógeno.
...
## Pipeline FrioSeguro (vivo — detalle en `dominios/comercial.md`)
...
## Bitácora
- 2026-08-31 (v5) — @comercial: **escenario de ENTRADA** agregado a la propuesta por pedido de Matías ("que vean un precio bajo antes de asustarse con el mediano"). 1 cámara · 1 sonda · 1 puerta · 1 base, Estándar, sin desarrollo a medida: **$ 200.000 inicial — de los cuales $ 150.000 son depósito que vuelve, o sea $ 50.000 de desembolso real — y $ 32.000/mes** (25.000 + 4.000 sonda + 3.000 puerta). Es lo primero que se ve en la página de precios, y se sube desde ahí: entrada → mediano Estándar $166.000 → mediano Premium $211.000. Argumento agregado: desde el de entrada se crece sumando sondas o cámaras **sin tocar nada de lo instalado** (la base admite 4 sondas y 3 puertas, no hace falta obra nueva ni otro depósito). El PDF sigue en **4 páginas**.
- 2026-08-31 (v4) — @comercial: **el abono de FrioSeguro/Termovigía se divide por 3.** Matías: "por mes queda muy caro todo, lo dividiría literalmente por 3". Los precios INICIALES no se tocan (depósito, desarrollo, instalación); solo baja el recurrente. **Tarifa v4:** primera cámara $25.000 · cámara adicional $15.000 · boca de sensado $4.000 · sensor de puerta $3.000 · sirena $3.000 · WhatsApp $8.000 · **base Premium $15.000** (única excepción deliberada al ÷3: esa línea paga la SIM 4G con SMS y llamadas, costo real $10-15k/mes por base; a $10.000 se vendería bajo costo). **Totales:** chico $700.000 + $62.000/mes (Estándar) y $1.210.000 + $92.000/mes (Premium); mediano $1.050.000 + $166.000/mes (Estándar) y $1.740.000 + $211.000/mes (Premium). Documento **rehecho de cero en 4 páginas A4** (era 10) y con hoja de estilos de impresión propia — el PDF salía recortado por maquetar a 900 px contra los 794 px de un A4 a 96 dpi. Lo que salió del documento del cliente vive ahora en `ANEXO_TECNICO.md`.
- 2026-08-31 (v3, CERRADA) — @comercial: Matías cerró todas las decisiones de Venado Tuerto. **Marca Termovigía confirmada.** Corrección de precio importante sobre la v2: el cargo por punto medido baja de $20.000 a **$10.000 plano por boca de sensado** (se elimina la escala por tramos) y se agrega **$10.000/mes por sensor de puerta**, que antes no estaba facturado. Resultado: el abono del escenario mediano baja de $550.000 a **$450.000/mes** y el chico de $222.000 a **$170.000/mes**. Confirmados tal cual los 7 números que había propuesto el agente (depósito batería $80.000, base Premium $30.000/mes, WhatsApp $25.000/mes, sirena $10.000/mes, desarrollo Premium $450.000, depósito ajustado por IPC al reintegrar, envío de devolución a nuestro cargo). **Transferencia al generador: a medida, no se da orden de magnitud** ni en el documento ni por teléfono. **Cobro: transferencia mensual** (ya escrito en el documento) y el vínculo se instrumenta en un único **contrato de servicio + comodato**. El desarrollo pendiente se ofrece igual, sin advertencias al cliente y sin fecha calendario — decisión tomada. **Totales v3:** chico $700.000 + $170.000/mes (Estándar) y $1.210.000 + $230.000/mes (Premium); mediano $1.050.000 + $450.000/mes (Estándar) y $1.740.000 + $540.000/mes (Premium). Solo quedan dos pendientes, ninguno bloquea el envío: **escribir el contrato servicio+comodato** (con anexo de valores de reposición, validado por contador) y **consultar INPI** por la marca.
- 2026-08-31 (v2) — @comercial: Venado Tuerto rearmado con las decisiones de Matías. **Cambio de modelo comercial de FrioSeguro para venta a distancia:** el hardware ya NO se vende — **comodato con depósito de garantía reintegrable** ($150.000 la base, $80.000 batería+cargador, $100.000 módulo 4G), con devolución por transporte a nuestro cargo y reintegro ajustado por IPC (a 600 km no hay retiro presencial posible). **Dos niveles de producto:** *Estándar* (WiFi del lugar, Telegram + push) y *Premium* (batería + módulo 4G que avisa por internet, SMS o llamada) — el Premium es el ÚNICO que puede avisar el corte de luz, y así está escrito: sin 4G el equipo se queda mudo y no se promete. Módulo opcional aparte: **transferencia automática a grupo electrógeno**. **Desarrollo a medida $300.000-$500.000** según alcance. **Abono:** $70.000 primera cámara + $40.000 adicional + **$20.000 por boca de sensado con escala por tramos** (5-10 $16.000 · 11-20 $13.000 · +20 $10.000) + $30.000/mes por base Premium; WhatsApp como canal = +$25.000/mes por sitio (Telegram y push incluidos). **Instalación: modelo único remoto $50.000/cámara — Matías NO viaja** (kit preconfigurado y probado en banco + electricista local + puesta en marcha por videollamada), vendido como ventaja, no como limitación; se eliminaron todos los viáticos. **Marca: "FrioSeguro" se descarta** (colisiona con Frío Seguro Monitoreo del Frío S.R.L.) → propuesto **TERMOVIGÍA**, 1 de 5 candidatos verificados por búsqueda web + DNS (.com y .com.ar libres, sin homónimo); verificación indicativa, **falta INPI**. Precios nuevos y decisión de nombre en `PREGUNTAS_PARA_MATIAS.md`.
- 2026-08-31 — @comercial: primer lead de FrioSeguro fuera de Bahía (Venado Tuerto, cámaras frías reguladas). Se cotiza con el escenario PREMIUM ya definido en `comercial/PRECIOS_FRIOSEGURO.md` + hardware en venta (a 600 km el comodato no se sostiene) + desarrollo a medida + viáticos. Regla aplicada: nada que no exista se vende como existente — va como "desarrollo incluido en la cotización". Estado completo del producto: `dominios/frioseguro_ESTADO_2026-08-31.md`.
